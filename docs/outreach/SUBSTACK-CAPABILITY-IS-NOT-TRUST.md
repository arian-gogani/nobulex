...
Most enterprise teams deploying agents in regulated industries are not yet building this. The deadline moved once already (from August 2026 to December 2027 via the Digital Omnibus), but the primitive the regulation requires did not change. The window to be the infrastructure they reach for is now.
