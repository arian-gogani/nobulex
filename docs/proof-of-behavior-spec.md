...
- **EU AI Act Article 12**  - Requires automatic event logging for high-risk AI systems. It does not require cryptographic signatures or tamper-evident records. Proof-of-behavior can provide additional evidence about whether stored records changed later, but the protocol alone does not establish legal compliance. Current application dates are December 2, 2027 for Annex III systems and August 2, 2028 for Annex I systems.
