...
**Protocol fee structure**: The protocol captures a fee of 0.15% on the volume of agent-mediated transactions that flow through Nobulex-verified channels. This fee is applied at the transaction layer and collected programmatically, requiring no manual invoicing or settlement. The fee rate is designed to be negligible relative to the value of the trust assurance provided: for a $1,000 transaction, the protocol fee is $1.50, compared to the potentially unlimited liability of transacting with an unverified agent.

**Revenue scaling**: The protocol's revenue scales linearly with the volume of agent-mediated economic activity. Industry estimates project that the agent economy will exceed $4 trillion annually by 2028 [1][2]. Even conservative adoption assumptions yield substantial protocol revenue: at 1% market penetration with the 0.15% fee rate, annual protocol revenue would reach $60 million, scaling to $600 million at 10% penetration.
